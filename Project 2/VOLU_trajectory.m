...
%equations when varying the initial volume of air in the bottle rocket
%INPUT: Time parameter and intial conditions
...
function [out] = VOLU_trajectory(t,y)
...
%%%%%%%%%%%%%%%%%%%%%%STAGE 1: WATER AND AIR IN BOTTLE%%%%%%%%%%%%%%%%%%%%%
    if VOL < volume_rocket + .00001
...
%%%%%%%%%%%%%%%%%%%%%%%STAGE 2: WATER EXHAUSTED%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%define air pressure in stage 2
    p = (p0*(v0/volume_rocket)^1.4)*(MAIR/m0)^1.4; %[Pa] %note: this pressure value is fucked because of the MAIR
    if VOL > volume_rocket && p > pa
%define temperature and pressure of the air once the water is expelled
%define temperature of air
      T1 = T0*(v0/volume_rocket)^.4; %[K]
